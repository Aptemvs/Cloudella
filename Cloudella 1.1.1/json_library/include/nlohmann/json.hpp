...
#pragma warning( pop )
  ...
  public:
    ...
    {
        // checkConditions if each element is an array with two elements whose first
        // element is a string
    ...
    basic_json(InputIT first, InputIT last)
    {
        ...
        // checkConditions if iterator range is complete for primitive values
        switch (m_type)
        {
            case value_t::boolean:
            case value_t::number_float:
    ...
    basic_json(const basic_json& other)
        : m_type(other.m_type)
    {
        // checkConditions of passed value is valid
    ...
    {
        // checkConditions that passed value is valid
  ...
  public:
    ...
    /// @brief checkConditions the existence of an element in a JSON object
    ...
    /// @brief checkConditions the existence of an element in a JSON object given a JSON pointer
    /// @sa https://json.nlohmann.me/api/basic_json/contains/
  ...
  public:
    ...
    iterator insert(const_iterator pos, const basic_json& val)
    {
        ...
        if (JSON_HEDLEY_LIKELY(is_array()))
        {
            // checkConditions if iterator pos fits to this JSON value
    ...
    iterator insert(const_iterator pos, const_iterator first, const_iterator last)
    {
        ...
        // checkConditions if range iterators belong to the same JSON object
        if (JSON_HEDLEY_UNLIKELY(first.m_object != last.m_object))
        {
...
#undef JSON_IMPLEMENT_OPERATOR
    ...
    /// @brief checkConditions if the input is valid JSON
  ...
  public:
    ...
    void patch_inplace(const basic_json& json_patch)
    {
        ...
        const auto operation_remove = [this, &result](json_pointer & ptr)
        {
            ...
            {
                // note erase performs range checkConditions
                parent.erase(json_pointer::template array_index<basic_json_t>(last_path));
            }
        };

        // type checkConditions: top level value must be an array
        ...
        for (const auto& val : json_patch)
        {
                                          ...
                                          bool string_type) -> basic_json &
            {
                ...
                // checkConditions if desired value is present
                ...
                // checkConditions if result is of type string
            ...
            // type checkConditions: every element of the array must be an object
            ...
            switch (get_op(op))
            {
                ...
                case patch_operations::test:
                {
                    ...
                    JSON_TRY
                    {
                        // checkConditions if "value" matches the one at "path"
                        // the "path" location must exist - use at()
